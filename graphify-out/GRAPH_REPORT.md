...
## Corpus Check
- 17 files · ~235,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2016 nodes · 2934 edges · 164 communities (123 shown, 31 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.85)
- Token cost: 164,949 input · 0 output
...
- **Provider Routing Indirection Chain** — docs_master_execution_plan_orchestrator_deps, docs_master_execution_plan_routed_extractor, docs_master_execution_plan_routed_responder, docs_master_execution_plan_ai_model_router, docs_master_execution_plan_claude_provider, docs_master_execution_plan_gemini_provider, docs_master_execution_plan_qwen_provider [EXTRACTED 1.00]
- **Evidence-Before-Claim Gate** — docs_master_execution_plan_verification_gates, docs_master_execution_plan_ci_is_the_judge, docs_master_execution_plan_owner_approval_gate, docs_master_execution_plan_test_live, docs_master_execution_plan_unverified_provider_limitation, docs_master_execution_plan_provider_evals [INFERRED 0.85]
- **The Model Is Not The Authority** — docs_master_execution_plan_postgres_as_source_of_truth, docs_master_execution_plan_prompt_injection_boundary, docs_master_execution_plan_risk_policy, docs_master_execution_plan_fallback_policy, docs_master_execution_plan_permission_model [INFERRED 0.85]
...
### Community 1 - "AI Provider Layer"
Cohesion: 0.05
Nodes (55): action_log, AI Documentation Set (AI_ARCHITECTURE / AI_PROVIDERS / AI_FALLBACK / AI_EVALS), AI_ENABLE_FALLBACK, AIModelRouter, AIProvider, AI_PROVIDER_ORDER, AnthropicExtractor, /api/undo (+47 more)
...
Cohesion: 0.05
Nodes (42): default, types, default, types, dependencies, @anthropic-ai/sdk, chrono-node, @google/genai (+34 more)

### Community 6 - "Extraction Eval Harness"
Cohesion: 0.09
...
### Community 7 - "Tool Layer and Errors"
Cohesion: 0.08
...
### Community 8 - "Turn Orchestrator"
Cohesion: 0.12
Nodes (36): blockedIntentIndices(), describeMention(), formatLocal(), IntentPlan, persistAssistantMessage(), planCommitment(), planCompletion(), PlanContext (+28 more)

### Community 9 - "Provider Options and Respond"
Cohesion: 0.10
Nodes (24): ClaudeProviderOptions, OLLAMA_DEFAULT_BASE_URL, OLLAMA_DEFAULT_MODEL, QwenProviderOptions, TracingResponder, assertNever(), describeFact(), formatDuration() (+16 more)

### Community 10 - "Migrations and Repositories"
Cohesion: 0.10
...
### Community 12 - "TypeScript Project Config"
Cohesion: 0.06
...
Cohesion: 0.11
Nodes (16): GEMINI_DEFAULT_INTERPRET_MODEL, GEMINI_DEFAULT_RESPOND_MODEL, GeminiLikeClient, GeminiLikeResponse, GeminiProvider, GeminiProviderOptions, generateContent(), REFUSAL_REASONS (+8 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (24): commit(), CompleteCommitmentInput, CompleteCommitmentInversePatch, CompleteCommitmentOutput, CompleteCommitmentRawInput, completeCommitmentTool, deriveCompletion(), isIsoDate() (+16 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (12): AIProvider, InterpretInput, AllProvidersFailedError, RESPOND_FALLBACK_REASONS, RoutedExtractor, RoutedInterpretation, RoutedReply, FakeOptions (+4 more)
...
Cohesion: 0.14
Nodes (16): categoryForExtractionError(), categoryForStatus(), classifyProviderError(), FAILURE_POLICY, FailurePolicy, messageOf(), ProviderError, readCode() (+8 more)
...
Cohesion: 0.10
Nodes (25): File-ownership map, /learn skill, /diagram skill, File-ownership table appended to plan, /plan-eng-review skill, Shared task list (5-6 tasks per teammate), Solutions Architect, Backend Lead (+17 more)
...
Cohesion: 0.15
Nodes (14): main(), Clock, evaluateDueWorkflows(), deps(), frozen(), OnFire, OnRuleFired, PollerDeps (+6 more)
...
Cohesion: 0.13
Nodes (20): action_log Grain Is The Conversational Turn, node-pg-migrate Forward-Only Migrations, pg Betweenness Bridge Finding, Cloudflare Workers Port, Framework-Agnostic Repository Boundary, pg Pinned To 8.16.3 Or Higher, Fastify Replaced By Next.js Route Handlers, Supabase Direct Connection, Never The Transaction Pooler (+12 more)
...
Cohesion: 0.13
Nodes (12): ActivityEntry, listRecentActivity(), FireReminderInput, FireReminderInversePatch, FireReminderOutput, FireReminderRawInput, fireReminderTool, isUuid() (+4 more)
...
Cohesion: 0.13
Nodes (14): @ourglass/api, dependencies, @anthropic-ai/sdk, @ourglass/shared, vitest, name, private, scripts (+6 more)
...
Cohesion: 0.16
Nodes (15): Defect Class: A Citation Is Not A Verification, Mutation-Proven Tests, Defect Class: Schema With No Code Path, A Query Tested Only With A Fake Transaction Is Untested, Recorded Defect-Class Sweep, Embedding Backfill, Defect Class: Fake-tx Test, Hybrid Retrieval Wiring (+7 more)

### Community 50 - "Community 50"
Cohesion: 0.15
Nodes (15): Flattened Conditional Workflows, In-Process Reminder Poller, Parallel Tool-Use Footgun, registry.coverage.test.ts Source Scan, One Postgres Instance With pgvector, Reminder Poller As Cron Trigger, correct_relationship Declared Gap, Four-Stage Orchestrator (+7 more)
...
Cohesion: 0.25
Nodes (3): AIModelRouter, correlationId(), RoutedResponder
...
Cohesion: 0.15
Nodes (12): description, engines, node, eslint, vitest, name, packageManager, private (+4 more)

### Community 60 - "Community 60"
Cohesion: 0.14
Nodes (13): dependencies, node-pg-migrate, @ourglass/shared, pg, pg, vitest, main, name (+5 more)

### Community 61 - "Community 61"
Cohesion: 0.19
Nodes (5): ClaudeProvider, EXTRACTION, provider(), REPLY, vitest
...
Cohesion: 0.20
Nodes (12): Every CI Job Is A Clean Runner, ESLint 9.39.5 Pin, Truncate-Per-Test Requires fileParallelism False, Secrets Never Enter The Repo, GitHub Actions CI, Public-Repo Hardening, Phase 4 - Understanding Over Time, ADMIN Permission Gap On batoredev/OurGlass (+4 more)
...
Cohesion: 0.18
Nodes (11): Independent Review Pipeline, WAT Operating Model (Workflows, Agents, Tools), CONFIRMED / INFERRED / UNCERTAIN Enum, The LLM Must Not Compute Timestamps, Sonnet and Haiku Only, Never Opus, Three-Tier Time Model, Extraction Eval Harness, Phase 2 - Interpret and Resolve (+3 more)

### Community 69 - "Community 69"
Cohesion: 0.22
Nodes (11): Bitemporal Modelling, Locked Decisions and Research Findings, Non-Destructive Merge, resolve_merged Cycle-Guarded Dereference, A Wrong Merge Is Worse Than A Duplicate, commitments Table, Ownership Direction (Spec 7), Ask band (0.65–0.92 or a tie) (+3 more)
...
Cohesion: 0.22
Nodes (10): 46-Role Agent Roster, Company Claude OS v2, Core Operating Principles, Default File-Ownership Map, Skill Ecosystem Routing, A Teammate Message Is Not A Permission Grant, Per-Phase Graphify Findings, Agent-Team Execution Model (+2 more)
...
Cohesion: 0.40
Nodes (5): /office-hours skill, Product / CEO Strategist, Evidence vs assumption labeling standard, /plan-design-review skill, UX Researcher
...
Cohesion: 0.67
Nodes (3): EXECUTION-PLAN.md, Master Execution Plan, Phase 8 Voice
...
## Knowledge Gaps
- **729 isolated node(s):** `EnumOption`, `Pool`, `Env`, `CommitmentStatusHint`, `ConditionReference` (+724 more)
...
- **Why does `Forced extract_intents tool call` connect `Community 39` to `Community 17`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `Extraction / ExtractedIntent Contract` connect `AI Provider Layer` to `Community 85`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **What connects `EnumOption`, `Pool`, `Env` to the rest of the system?**
